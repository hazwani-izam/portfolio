...
function populatePortfolio () {
  ...
  for(var i=0; i<_portfolioArr.length; i++) {
    ...
    for( var j=0; j<_portfolioItems.length; j++) {
      ...
      _accordionStr += '<div data-aos="fade-up" data-aos-duration="500" class="card active" id="card'+_accordionId+'_'+(j+1)+'"> <button aria-controls="'+_accordionId+'_'+(j+1)+'" aria-expanded="false" class="btn btn-link" data-target="#'+_accordionId+'_'+(j+1)+'" data-toggle="" type="button"> <div class="card-header" id="'+_accordionId+'-'+(j+1)+'"> <div class="row justify-content-between align-items-center"> <div class="col"> <h2>'+_portfolioItems[j].title+'</h2> <img src="assets/images/header@2x.png"> </div> </div> </div> </button> <div aria-labelledby="'+_accordionId+'-'+(j+1)+'" class=" show " id="'+_accordionId+'_'+(j+1)+'"> <a href="portfolio/'+_portfolioItems[j].link+'.html" target="_blank"> <div class="card-body bg-black"> <img src="assets/images/portfolio/thumbnails/Thumbnail_'+_portfolioItems[j].image+'"> <div class="tags">'+_portfolioItems[j].tags+'</div> </div> </a> </div> </div>';
    }
      _accordionStr +=  '</div>';
  }
